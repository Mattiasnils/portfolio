...
(function initBodyTextReveal() {
  ...
  const skipClosest =
    ".tool-badge, .soft-skill, .work-card, .company-card, .blog-post, .headline, #introduction, #parallax-container, #contact-modal, .interests-lightbox, header, nav, footer, .contact-form, .contact-button, .nova-talent-link, .coming-soon";
